...
<div class="add-task-form form-horizontal">
    ...
    <div class="row cl">
        ...
        <div class="col-xs-10 col-sm-10 unit-action-box" id="unit-action-box">
            ...
            <button action_id="1" class="btn btn-default radius"><span>actionA</span><i class="unit-action-del"></i>
            </button>
            <button action_id="2" class="btn btn-default radius"><span>actionA</span><i class="unit-action-del"></i>
            </button>
            <button action_id="3" class="btn btn-default radius"><span>actionA</span><i class="unit-action-del"></i>
            </button>
            <button action_id="4" class="btn btn-default radius"><span>actionAactions</span><i
                    class="unit-action-del"></i></button>
            <button action_id="5" class="btn btn-default radius"><span>actionAactions</span><i
                    class="unit-action-del"></i></button>
            <button action_id="6" class="btn btn-default radius"><span>actionA</span><i class="unit-action-del"></i>
            </button>
            <button action_id="7" class="btn btn-default radius"><span>actionA</span><i class="unit-action-del"></i>
            </button>
            <button action_id="8" class="btn btn-default radius"><span>actionA</span><i class="unit-action-del"></i>
            </button>
            <button action_id="9" class="btn btn-default radius"><span>actionA</span><i class="unit-action-del"></i>
            </button>
            ...
            <button action_id="14" class="btn btn-primary radius" add_btn style="padding: 0 20px">+</button>
        </div>
    </div>
    <div class="row cl">
        ...
        <div class="col-xs-10 col-sm-10 group-action-box" id="group-action-box">
            <div class="groups-box">
                <div group_id="0" class="group-action-item">
                    <div class="group-action-name">
                        <span>动作组一</span>
                        <i>ed</i>
                    </div>
