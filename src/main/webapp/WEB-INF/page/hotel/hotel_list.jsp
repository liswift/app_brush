...
<div class="pd-20">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a class="btn btn-primary radius" onclick="hotel_add('添加酒店','${ctx}/hotel/toAddHotel')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 酒店添加</a></span> <span class="r">共有数据：<strong>54</strong> 条</span> </div>
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<c:forEach items="${ data }" var="d" >
				<tr class="text-c">
					...
					<td>${d.id }</td>
					<td>${d.hotel_name }</td>
					<td><a href="javascript:;" onClick="picture_edit('图库编辑','${ctx}/hotel/toRoomImage/${d.id }','10001')"><img width="100" class="picture-thumb" src="${ctx }/hotel_img/${d.img}.jpg"></a></td>
					<td class="text-l">${d.tel }</td>
					<td class="text-c">${d.address }</td>
					<td><c:if test="${d.star == 5 }">五星级</c:if>  </td>
