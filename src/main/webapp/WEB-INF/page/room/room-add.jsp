...
<body>
<div class="pd-20">
	<form action="${ctx }/room/addRoom"  method="post" class="form form-horizontal" id="form-article-add">
		<label class="form-label col-9"><span class="c-red">*房型的图片批量上传以后，可以在房间列表中点击酒店图片（房间）查看</span></label><br/>
		<div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-2">所属酒店：</label>
			<div class="formControls col-5"> <span class="select-box">
				<select name="hotel_name" class="select">
...
$(function(){
	...
	var uploader = WebUploader.create({
		...
		// 文件接收服务端。
		server: '${ctx}/photo/roomPhotoUpload',
