		...
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			<thead>
				<tr class="text-c">
					...
					<th width="100">酒店图片（房间）</th>
					<th width="150">所属酒店</th>
					<th width="60">价格</th>
					<th width="60">平方米</th>
					<th width="60">创建时间</th>
					<th width="100">操作</th>
			...
			<c:forEach items="${ data }" var="d" >
				<tr class="text-c">
					...
					<td>${d.id }</td>
					<td>${d.name }</td>
					<td><a href="javascript:;" onClick="picture_edit('图库编辑','${ctx}/room/toRoomImage/${d.id }','10001')"><img width="100" class="picture-thumb" src="${ctx }/hotel_img/${d.img}.jpg"></a></td>
					<td class="text-l">${d.hotel_name }</td>
					<td class="text-c">${d.price }</td>
					<td></td>
					<td>${d.create_time }</td>
