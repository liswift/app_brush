...
<body>
<div class="pd-20">
  <form action="${ctx }/station/updateStation" method="post" class="form form-horizontal" id="form-member-add">
   	<div class="row cl">
      <label class="form-label col-3"><span class="c-red">*</span>线路名：</label>
      <div class="formControls col-5">
       <select name="lineid" class="select">
    ...
    <div class="row cl">
      <label class="form-label col-3"><span class="c-red">*</span>站点名：</label>
      <div class="formControls col-5">
        <input type="text" class="input-text" value="${station.name }" placeholder="" id="member-name" name="name" datatype="*" nullmsg="城市名不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
...
$(function(){
	...
	$("#save").click(function() {
        ...
        $.post("${ctx }/station/updateStation", d, function (result) { 
