...
<body>
<div class="pd-20">
  <form action="${ctx }/city/updatecity" method="post" class="form form-horizontal" id="form-member-add">
    <div class="row cl">
      <label class="form-label col-3"><span class="c-red">*</span>城市名：</label>
      <div class="formControls col-5">
        <input type="text" class="input-text" value="${name }" placeholder="" id="member-name" name="name" datatype="*" nullmsg="城市名不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    ...
    <div class="row cl">
		...
		<div class="formControls col-5">
			<textarea name="desc" cols="" rows="" class="textarea"  placeholder="说点什么...100个字符以内" dragonfly="true" onKeyUp="textarealength(this,100)">${desc }</textarea>
