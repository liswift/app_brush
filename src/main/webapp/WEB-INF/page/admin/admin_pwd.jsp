...
<body>
<div class="pd-20">
	<form action="${ctx }/sys/forgetpwd" method="post" class="form form-horizontal" id="form-admin-add">
		
		<div class="row cl">
			<label class="form-label col-3"><span class="c-red"></span>用户名：</label>
			<div class="formControls col-5">
				<input type="text" name="name" value="${user.name }" autocomplete="off" class="input-text " readonly="readonly">
			</div>
			<div class="col-4"> </div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-5">
				<input type="password" name="password" autocomplete="off" class="input-text">
			</div>
			<div class="col-4"> </div>
		</div>
		<div class="row cl">
...
$(function(){
	...
	$("#save").click(function() {
        ...
        $.post("${ctx }/sys/forgetpwd", d, function (result) { 
