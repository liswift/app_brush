			...
			<table class="table table-border table-bordered table-bg table-hover table-sort">
				...
				<tbody>
					...
					<tr class="text-c va-m">
						...
						<td>${d.DESCRIPTION }</td>
						<td class="td-manage">
							<a href="${ctx }/permission/submenu/${d.id}">子菜单</a>
							<a href="javascript:;" onclick="edit_menu('修改主菜单','${ctx }/permission/toEditMenu/${d.id}','700','300')" >编辑</a> 
							<shiro:hasPermission name="sys:perm:delete">
								<a href="${ctx }/permission/delmenu/${d.id}">删除</a>
							</shiro:hasPermission>
						</td>
					</tr>
					</c:forEach>
