...
//            simpleAuthorInfo.addRole("web");
//            //添加权限  
//            simpleAuthorInfo.addStringPermission("web:manage");
//            System.out.println("已为用户[mike]赋予了[web]角色和[web:manage]权限");
//            return simpleAuthorInfo;  
//        }
        //若该方法什么都不做直接返回null的话,就会导致任何用户访问/web/listUser.jsp时都会自动跳转到unauthorizedUrl指定的地址
