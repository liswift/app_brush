...
public class ArgumentController extends BaseController {
    ...
    /**
     * 静态参数:
     * 客户端回调网络请求获取数据: netapi|getPhonenumberCode_key=value&key=value 动态参数,传递到客户端变为固定参数,网络请求的时候必须为固定参数
     * 直接网络请求获取数据:      net|getPhonenumbercode_key=value&key=value  内部参数只能是固定参数,过来就会触发网络请求
     *
     * 动态参数:
